...
function useRotateYValues(
  ...
  const rotateYValues: MotionValue<number>[] = [];
...
export default function Carousel({
  ...
  const rotateYValues = useRotateYValues(
    x,
    ...
    <div
      ...
      className={`relative overflow-hidden p-4 ${
        round
          ...
          : "rounded-[24px] border border-[#222] dark:border-white"
      }`}
      style={{
        width: `${baseWidth}px`,
          ...
          <motion.div
            ...
            className={`relative shrink-0 flex flex-col ${
              round
                ...
                : "items-start justify-between bg-[#222] dark:bg-white border border-[#222] dark:border-white rounded-[12px]"
